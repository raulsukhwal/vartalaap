...
class _IndividualPageState extends State<IndividualPage> {
          ...
          child: Column(
            children: [
              Row(
                ...
                children: [
                  iconCreation(
                      Icons.insert_drive_file, Color(0xff004AAD), "Document"),
                  SizedBox(
                    width: 40,
                  ),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  iconCreation(Icons.headset, Color(0xff004AAD), "Audio"),
                  SizedBox(
                    width: 40,
                  ),
                  iconCreation(
  ...
  Widget emojiSelect() {
    return EmojiPicker(onEmojiSelected: (emoji, category) {
      print(emoji);
      setState(() {
        _controller.text = _controller.text + (emoji?.name.toString() ?? "");
      });
    });
  }
}
